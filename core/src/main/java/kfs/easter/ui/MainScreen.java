...
public class MainScreen extends BaseScreen {
    ...
    public void show() {
        ...
        // Title
        Label.LabelStyle titleStyle = new Label.LabelStyle(fontBig, Color.YELLOW);
        Label title = new Label("EASTER EGG", titleStyle);
        table.add(title).padBottom(10).row();

        Label.LabelStyle subStyle = new Label.LabelStyle(fontSmall, Color.WHITE);
        table.add(new Label("Velikonocni hra pro Kubu", subStyle)).padBottom(30).row();
